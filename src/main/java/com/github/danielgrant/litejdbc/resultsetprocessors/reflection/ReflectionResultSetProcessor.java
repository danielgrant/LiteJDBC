...
public abstract class ReflectionResultSetProcessor<T> implements ResultSetProcessor<T> {
  ...
  public T processResultSet(ResultSet resultSet) throws SQLException {
    ...
    try {
      ...
      throw ExceptionTranslator.translateReflectionException(
          "ReflectionResultSetProcessor.processResultSet()", targetClass, exception);
  ...
  private PropertyDescriptor createPropertyDescriptor(Field field, Class<T> targetClass)
  ...
  private void writeValueToMethod(Object targetObject, Object resultSetValue, Method writeMethod)
