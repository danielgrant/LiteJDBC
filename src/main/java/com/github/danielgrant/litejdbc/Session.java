...
public interface Session {
    ...
    public <T> T findObject(String sql, Object[] parameters, int[] sqlTypes, ResultSetProcessor<T> databaseResultSetProcessor);

    public <T> List<T> findList(String sql, Object[] parameters, int[] sqlTypes, ResultSetProcessor<T> databaseResultSetProcessor);

    public <T> T findObjectUsingReflection(String sql, Object[] parameters, int[] sqlTypes, Class<T> targetClass);

    public <T> List<T> findListUsingReflection(String sql, Object[] parameters, int[] sqlTypes, Class<T> targetClass);
